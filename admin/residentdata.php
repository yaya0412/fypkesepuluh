...
<form method="POST">
    ...
    <input type="date" name="tarikh_daftar_masuk" placeholder="Admission Date" required>
    ...
    <input type="date" name="tarikhlahir" placeholder="Birth Date" required>
...
<!-- Input field for specifying the type of allergy -->
<input type="text" id="nyatakan_alahan" name="nyatakan_alahan" placeholder="Specify here..." style="display: none;">

<script>
function handleSelection() {
    const selectedValue = document.getElementById('jenis_alahan').value;
    const nyatakanInput = document.getElementById('nyatakan_alahan');

    // Show the input field only for "Yes" and "Other", otherwise hide it
    nyatakanInput.style.display = (selectedValue === 'yes' || selectedValue === 'other') ? 'block' : 'none';
}
</script>
